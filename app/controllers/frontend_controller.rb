class FrontendController < ApplicationController
  ...
  # 	})
	...
	def funnel_product_purchased
		...
		@shop.funnel_reports.create(product_id: params[:product_id],up_product_id: params[:upsell_product],price: params[:price],action: params[:action]) if params[:upsell_product].present?
		@shop.funnel_reports.create(product_id: params[:product_id],down_product_id: params[:downsell_product],price: params[:price],action: params[:action]) if params[:downsell_product].present?
	end
