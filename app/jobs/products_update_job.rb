  ...
  def perform(shop_domain:, webhook:)
    ...
    @shop.with_shopify_session do
      ...
      puts "========in update========================="
        ...
        @tag_array = []
        @query = @shop.filter_shop_products.find_by(:product_id => @product_id).update(:product_id => @product_id,:title => @product_title,handle: @product_handle,vendor: @product_vendor,product_type: @product_type,tags: @product_tags)
